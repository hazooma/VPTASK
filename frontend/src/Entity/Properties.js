...
const Property = (props) => {
  ...
  let trial = (event) => {
    const i = property.type === 'b' ? event.currentTarget.elements[0].value : event.currentTarget.elements[1].value
    ...
    setCont({
      ...cont,
      payload: cont.Push[props.entityid].properties[props.id].value = i

    });
    if (property.type === 'b') {
      setCont({
        ...cont,
        payload: cont.Push[props.entityid].properties[props.id].op = '='
      ...
      setCont({
        ...cont,
        payload: cont.Push[props.entityid].properties[props.id].op = event.currentTarget.elements[0].value
